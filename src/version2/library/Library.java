...
//---  Operations   ---------------------------------------------------------------------------
	...
	public boolean enrolUser(int userId, String organization) {
		...
		users.addResource(users.compileUser(userId, organization, MAXIMUM_CHECKOUT_LIMIT));
...
//---  Support Methods   ----------------------------------------------------------------------
	 ...
	 * 
	 * @param userlId - int value denoting which material in the Library the User is trying to check out
